...
<html lang="en" class="pxp-root">
    <head>
        ...
        <title>Optimal Outsourcing - Candidate dashboard</title>
    </head>
        ...
        <div class="pxp-dashboard-side-panel d-none d-lg-block">
            ...
            <nav class="mt-3 mt-lg-4 d-flex justify-content-between flex-column pb-100">
                ...
                <ul class="list-unstyled">
                    <li class="pxp-active"><a href="candidate-dashboard.html"><span class="fa fa-home"></span>Dashboard</a></li>
                    <li><a href="candidate-dashboard-profile.html"><span class="fa fa-pencil"></span>Edit Profile</a></li>
                ...
                <div class="pxp-dashboard-side-user-nav">
                    <div class="dropdown pxp-dashboard-side-user-nav-dropdown dropup">
                        <a role="button" class="dropdown-toggle" data-bs-toggle="dropdown">
                            <div class="pxp-dashboard-side-user-nav-avatar pxp-cover" style="background-image: url(images/ph-small.jpg);"></div>
