            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-7">
                            <div class="pxp-jobs-list-single-column nav mt-4 mt-xxl-0" role="tablist">
                                ...
                                @if ($index == 0)
                                <a class="pxp-jobs-card-4 pxp-has-border active" id="{{'job-'.$job->job_id}}" data-bs-toggle="tab"
                                    data-bs-target="{{'#job-details-'.$job->job_id}}" role="tab" aria-controls="{{'job-details-'.$job->job_id}}"
                                    aria-selected="true">
                                    ...
                                    <div class="pxp-jobs-card-4-company-bottom">
                                        <div class="pxp-jobs-card-4-category">
                                            <span class="pxp-jobs-card-4-company">{{$job->user->first_name.' '.$job->user->last_name}}</span>
                                        </div>
                                        <div class="pxp-jobs-card-4-bottom-right">
                                            <span class="pxp-jobs-card-4-date pxp-text-light">{{$job->created_at->diffForHumans()}}</span>
                                        </div>
                                    </div>
                                </a>
                                @else
                                <a class="pxp-jobs-card-4 pxp-has-border" id="{{'job-'.$job->job_id}}" data-bs-toggle="tab"
                                    data-bs-target="{{'#job-details-'.$job->job_id}}" role="tab" aria-controls="{{'job-details-'.$job->job_id}}"
                                    aria-selected="true">
                                    <div class="pxp-jobs-card-4-company-top">
                                        <div class="pxp-jobs-card-4-company-logo"
                                            style="background-image: url({{asset('assets/images/company-logo-2.png')}});"></div>
                                        <div class="pxp-jobs-card-4-info">
                                            <div class="pxp-jobs-card-4-title">{{$job->job_title}}</div>
                                            <div class="pxp-jobs-card-4-details">
                                                <div class="pxp-jobs-card-4-location pxp-text-light">
                ...
                <div class="col-lg-7 col-xl-8 col-xxl-6">
                    <div class="tab-content pxp-jobs-tab-content">
                        @foreach ($jobs as $index=>$job)
                        @if ($index == 0)
                        <div class="tab-pane active" id="{{'job-details-'.$job->job_id}}" role="tabpanel" aria-labelledby="{{'job-'.$job->job_id}}">
                            <div class="pxp-jobs-tab-pane-cover pxp-cover"
                                style="background-image: url({{asset('assets/images/ph-big.jpg')}});"></div>
                            <div class="pxp-jobs-tab-pane-logo" style="background-image: url({{asset('assets/images/company-logo-1.png')}});">
                            </div>
                            <div class="pxp-jobs-tab-pane-content">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-xl-6">
                                        ...
                                        <div class="pxp-jobs-tab-pane-company-location">
                                            by <a href="single-company-1.html" class="pxp-jobs-tab-pane-company">{{$job->user->first_name.' '.$job->user->last_name}}</a> in
                                            <a href="jobs-list-1.html" class="pxp-jobs-tab-pane-location">{{$job->location}}
                                                </a>
                                        </div>
                                    </div>
                                    <div class="col-xl-auto">
                                        <div class="pxp-jobs-tab-pane-options mt-4 mt-xl-0">
                                            ...
                                            <button class="btn ms-2 pxp-jobs-tab-pane-apply-btn rounded-pill">Apply
                                                Now</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4 justify-content-between align-items-center">
                                    <div class="col-6">
                                        <a href="jobs-list-1.html" class="pxp-jobs-tab-pane-category">
                                            ...
                                            <div class="pxp-jobs-tab-pane-category-label">{{$job->category}}</div>
                                        </a>
                                    </div>
                                    <div class="col-auto">
                                        <div class="pxp-jobs-tab-pane-date pxp-text-light">{{$job->created_at->diffForHumans()}}</div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4 mt-lg-5 align-items-center">
                                    <div class="col-6">
                                        <div>
                                            <div class="pxp-jobs-tab-pane-content-info-label pxp-text-light">Experience
                                            </div>
                                            <div class="pxp-jobs-tab-pane-content-info-data">{{$job->experience}}</div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div>
                                            <div class="pxp-jobs-tab-pane-content-info-label pxp-text-light">Work Level
                                            </div>
                                            <div class="pxp-jobs-tab-pane-content-info-data">{{$job->career_level}}</div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mt-4">
                                            <div class="pxp-jobs-tab-pane-content-info-label pxp-text-light">Employment
                                                Type</div>
                                            <div class="pxp-jobs-tab-pane-content-info-data">{{$job->employment_type}}</div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mt-4">
                                            <div class="pxp-jobs-tab-pane-content-info-label pxp-text-light">Salary</div>
                                            <div class="pxp-jobs-tab-pane-content-info-data">{{$job->salary_range}} / year</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="pxp-jobs-tab-pane-content-details mt-4 mt-lg-5">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <ul>
                                            <li>Be involved in every step of the product design cycle from discovery to
                                            ...
                                            <li>Maintain quality of the design process and ensure that when designs are
                                                translated into code they accurately reflect the design specifications.</li>
                                            <li>Accurately estimate design tickets during planning sessions.</li>
                                            <li>Contribute to sketching sessions involving non-designersCreate, iterate and
                                                maintain UI deliverables including sketch files, style guides, high fidelity
                                                prototypes, micro interaction specifications and pattern libraries.</li>
                                            <li>Ensure design choices are data led by identifying assumptions to test each
                                                sprint, and work with the analysts in your team to plan moderated usability
                                                test sessions.</li>
                                    ...
                                    <div class="mt-4">
                                        <h4>Requirements</h4>
                                        <ul>
                                            <li>4+ years of system administration experience with the Microsoft Server
                                                platform (2012/2016, Microsoft IIS, Active Directory)</li>
                                            <li>3+ years of hands-on system administration experience with AWS (EC2, Elastic
                                                Load Balancing, Multi AZ, etc.)</li>
                                            <li>4+ years of SQL Server, MySQL</li>
                                            <li>Working knowledge of Encryption techniques and protocols, Multi-factor
                                                authentication, Data protection, Penetration testing, Security threats</li>
                                    ...
                                    <div class="mt-4">
                                        <h4>Skills</h4>
                                        <ul>
                                            <li>Programming experience developing web applications with the Microsoft .NET
                                            ...
                                            <li>Hypervisors, SAN’s, load balancers, firewalls, and Web Application Firewall
                                                (WAF)</li>
                        ...
                        @else
                        <div class="tab-pane" id="{{'job-details-'.$job->job_id}}" role="tabpanel" aria-labelledby="{{'job-'.$job->job_id}}">
                            <div class="pxp-jobs-tab-pane-cover pxp-cover"
                                style="background-image: url({{asset('assets/images/ph-big.jpg')}});"></div>
                            <div class="pxp-jobs-tab-pane-logo" style="background-image: url({{asset('assets/images/company-logo-2.png')}});">
                            </div>
                            <div class="pxp-jobs-tab-pane-content">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-xl-6">
                                        ...
                                        <div class="pxp-jobs-tab-pane-company-location">
                                            by <a href="single-company-1.html"
                                                class="pxp-jobs-tab-pane-company">{{$job->user->first_name.' '.$job->user->last_name}}</a> in
                                            <a href="jobs-list-1.html" class="pxp-jobs-tab-pane-location">{{$job->location}}</a>
                                        </div>
                                    </div>
                                    <div class="col-xl-auto">
                                        <div class="pxp-jobs-tab-pane-options mt-4 mt-xl-0">
                                            ...
                                            <div class="dropdown ms-2">
                                                <button class="btn pxp-jobs-tab-pane-share-btn dropdown-toggle"
                                                    type="button" id="socialShareBtn-2" data-bs-toggle="dropdown"
                                                    aria-expanded="false">
                                                    <span class="fa fa-share-alt"></span>
                                                </button>
                                                <ul class="dropdown-menu pxp-jobs-tab-pane-share-dropdown"
